...
local function initForageableMaps()
    if SandboxVars.MoreMaps.ForageableMaps then
        ...
        if SandboxVars.MoreMaps.WildberriesMap and getActivatedMods():contains("wildberries") then
            forageDefs["WildberriesMap"] = {
                type = "Base.WildberriesMap",
                skill = 4,
                xp = 50,
                categories = { "Junk" },
                zones = {
        ...
        if SandboxVars.MoreMaps.TugalandMap and getActivatedMods():contains("Tugaland") then
            forageDefs["TugalandMap"] = {
                type = "Base.TugalandMap",
                skill = 4,
                xp = 50,
                categories = { "Junk" },
                zones = {
        ...
        if SandboxVars.MoreMaps.TrimbleCountyMaps and getActivatedMods():contains("TrimbleCountyPowerStation") then
            forageDefs["TrimbleCountyPowerStationMap"] = {
                type = "Base.TrimbleCountyPowerStationMap",
                skill = 4,
                xp = 50,
                categories = { "Junk" },
                zones = {
            ...
            forageDefs["TrimbleCountyLaGrangeMap"] = {
                type = "Base.TrimbleCountyLaGrangeMap",
                skill = 4,
                xp = 50,
                categories = { "Junk" },
                zones = {
        ...
        if SandboxVars.MoreMaps.OldPineVillageMap and getActivatedMods():contains("Old Pine Village") then
            forageDefs["OldPineVillageMap"] = {
                type = "Base.OldPineVillageMap",
                skill = 4,
                xp = 50,
                categories = { "Junk" },
                zones = {
